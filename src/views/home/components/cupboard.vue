      ...
      >
        <div class="w-full flex flex-col items-start">
          ...
          <p ref="description" class="desc opacity-0 translate-y-10">
            Acumenbot can remember conversations from months ago thanks to
            its powerful memory, but you can make it forget
            anything at anytime if you prefer it that way.
          </p>
