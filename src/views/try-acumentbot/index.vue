<template>
  <div class="bg-black w-full overflow-hidden pb-[301px]">
    ...
    <div class="max-w-[1920px] mx-auto flex flex-col items-center px-4 md:px-8 text-white">
      ...
      <div ref="imageBox" class="image-box mt-[126px] opacity-0 relative" v-show="isStarted">
        <div v-show="isSpeaking || isBotSpeaking" :class="[
        'light',
        { 'bot-light': isBotSpeaking, 'user-light': isSpeaking },
      ]" class="absolute top-[80px] left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
        <img v-show="!isSpeaking && !isBotSpeaking" src="@/assets/bot/noactive.png" alt=""
          class="noactive relative z-10" />
          
        <img v-show="isSpeaking" src="@/assets/bot/active-blue.png" alt="" class="active-blue relative z-10" />
        <img v-show="isBotSpeaking" src="@/assets/bot/active-sky.png" alt="" class="active-sky relative z-10" />
      </div>

      <button ref="startBtn" class="start cursor-pointer opacity-0" @click="start">
